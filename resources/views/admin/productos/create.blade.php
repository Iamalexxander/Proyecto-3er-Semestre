            ...
            <div class="card border-0 shadow-2xl" style="background: rgba(15, 23, 42, 0.95); backdrop-filter: blur(20px);">
                <div class="card-header border-bottom border-accent p-4"
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <h3 class="text-white mb-0 flex-grow-1">Crear Nuevo Producto</h3>
                    </div>
                </div>

                <div class="card-body p-4 text-white">
                    <form action="{{ route('admin.productos.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        ...
                        <div class="row g-4">
                            ...
                            <!-- Columna Derecha -->
                            <div class="col-md-6">
                                <div class="image-selection-container p-4 rounded-3 mb-4"
                                    ...
                                    @enderror
                                    <div class="invalid-feedback d-block" id="imagen-error" style="display: none;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const imageRadios = document.querySelectorAll('input[name="imagen"]');
